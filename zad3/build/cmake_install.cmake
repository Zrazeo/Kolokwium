# Install script for directory: /home/croxoner/Pulpit/Kolokwium/zad3
...
file(INSTALL DESTINATION "/usr/lib" TYPE SHARED_LIBRARY FILES "/home/croxoner/Pulpit/Kolokwium/zad3/build/libstudlib.so")
  if(EXISTS "$ENV{DESTDIR}/usr/lib/libstudlib.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/lib/libstudlib.so")
...
file(INSTALL DESTINATION "/usr/bin" TYPE EXECUTABLE FILES "/home/croxoner/Pulpit/Kolokwium/zad3/build/studentapp")
  if(EXISTS "$ENV{DESTDIR}/usr/bin/studentapp" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/bin/studentapp")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/bin/studentapp"
         OLD_RPATH "/home/croxoner/Pulpit/Kolokwium/zad3/build:"
         NEW_RPATH "")
    if(CMAKE_INSTALL_DO_STRIP)
...
file(WRITE "/home/croxoner/Pulpit/Kolokwium/zad3/build/${CMAKE_INSTALL_MANIFEST}"
     "${CMAKE_INSTALL_MANIFEST_CONTENT}")
